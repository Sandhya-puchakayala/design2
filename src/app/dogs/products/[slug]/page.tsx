...
> = {
  'dry-food': {
    ...
    description:
      'Crunchy, complete dry food options for everyday meals, tailored to different breeds and life stages.',
    products: [
      {
        id: 'p1',
        name: 'Royal Canin Golden Retriever Adult Dog Dry Food',
        brand: 'Royal Canin',
        price: '₹10,173',
        mrp: '₹11,565',
        discount: '12% OFF',
      ...
      {
        id: 'p2',
        name: 'Henlo Baked Chicken & Liver Adult Dog Dry Food',
        brand: 'Henlo',
        price: '₹1,109',
        mrp: '₹1,299',
        discount: '15% OFF',
      ...
      {
        id: 'p3',
        name: 'Drools Adult Chicken & Egg Dry Dog Food',
        brand: 'Drools',
        price: '₹2,499',
        mrp: '₹2,899',
        discount: '14% OFF',
  ...
  'wet-food': {
    title: 'Wet Food for Dogs',
    description: 'Tasty wet food meals to add variety and hydration to your dog’s diet.',
    products: [
      {
        id: 'p4',
        name: 'Gravy Chicken & Liver Wet Dog Food Pouch',
        brand: 'Pedigree',
        price: '₹85',
        mrp: '₹95',
        discount: '10% OFF',
...
export default function DogsProductsPage({
  params,
}: {
  params: { slug: string };
}) {
