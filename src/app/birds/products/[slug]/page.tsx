...
> = {
  'dry-food': {
    title: 'Dry Food for Birds',
    description:
      'Nutritious dry food options formulated for different bird species and life stages.',
    products: [
      {
        id: 'b1',
        name: 'Parrot Mix Premium Bird Dry Food',
        brand: 'Vitapol',
        price: '₹599',
        mrp: '₹699',
        discount: '14% OFF',
      ...
      {
        id: 'b2',
        name: 'Cockatiel Seed Mix Dry Bird Food',
        brand: 'Beaphar',
        price: '₹849',
        mrp: '₹999',
        discount: '15% OFF',
      ...
      {
        id: 'b3',
        name: 'Canary Premium Blend Bird Food',
        brand: 'Dr Salim',
        price: '₹449',
        mrp: '₹549',
        discount: '18% OFF',
  ...
  'wet-food': {
    title: 'Wet Food for Birds',
    description: "Fresh and moist food options to add nutritional variety to your bird's diet.",
    products: [
      {
        id: 'b4',
        name: 'Sprouted Seeds Bird Food Wet Mix',
        brand: 'Harrison',
        price: '₹299',
        mrp: '₹349',
        discount: '14% OFF',
...
export default function BirdsProductsPage({
  params,
}: {
  params: { slug: string };
}) {
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <aside className="w-full lg:w-64 bg-background-card border border-border-light rounded-2xl p-4 space-y-5">
            ...
            <div className="space-y-2">
              ...
              {['Parrot', 'Cockatiel', 'Canary'].map((label) => (
                <label
                  key={label}
